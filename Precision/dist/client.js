function parseClient() {
    ...
    if (isMturk()) {
        ...
        client.type = 'prolific';
        client.PROLIFIC_ID = getParameterByName('PROLIFIC_ID');
        client.STUDY_ID = getParameterByName('STUDY_ID');
        client.SESSION_ID = getParameterByName('SESSION_ID');
        client.sid = 'sona-' + client.PROLIFIC_ID;
    }
    // else if (isSona()) {
    //     // is sona
    //     client.type = 'sona';
...
function isProlific() {
    var PROLIFIC_ID = getParameterByName("PROLIFIC_ID");
    // console.log(PROLIFIC_ID)
    var STUDY_ID = getParameterByName("STUDY_ID");
